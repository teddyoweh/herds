...
/* ── Shared auth chrome (kept inline; these pages own their own files) ── */
    ...
    <div className="fixed inset-0 z-[80] grid place-items-center overflow-y-auto bg-ink-950 px-4 py-12">
      ...
      >
        ...
        <p className="mt-6 text-center text-[13px] text-zinc-600">
          ...
          <Link href="/login" className="text-zinc-300 underline-offset-4 transition hover:text-white hover:underline">
            Log in
          </Link>
        </p>
      </motion.div>
